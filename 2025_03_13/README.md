...
## 목차
  - [1주차: 기초 사항 / 애플리케이션의 기본 구조](#1주차--기초-사항--애플리케이션의-기본-구조)
    - [안드로이드 애플리케이션의 주요 컴포넌트](#안드로이드--애플리케이션의--주요--컴포넌트)
    - [안드로이드에서의 인텐트(Intent)](#안드로이드에서의--인텐트intent)
    - [안드로이드 애플리케이션의 구조](#안드로이드--애플리케이션의--구조)
    - [일반적인 애플리케이션 작성 절차](#일반적인--애플리케이션--작성--절차)
  - [2주차: 기본 위젯(1)](#2주차-기본-위젯1)
    - [UI 단위 개념 정리](#ui-단위-개념-정리)
    - [난수 표시 앱](#난수-표시-앱)
  - [3주차: 기본 위젯(1)(2), 과제(1)](#3주차-기본-위젯12-과제1)
    - [에디트 텍스트 사용하기 1](#에디트-텍스트-사용하기-1)
    - [과제1: 에디트 텍스트 사용하기 2](#과제1-에디트-텍스트-사용하기-2)
  - [4주차: 과제(1)(2)](#4주차-과제12)
    - [과제 1: 주사위 굴리기](#과제-1-주사위-굴리기)
    - [과제 2: 계산기 앱](#과제-2-계산기-앱)
